    ...
    return (
      <div className="flex flex-col gap-2 w-full">
        ...
        <textarea
          ...
          id={inputId}
          rows={rows}
          className={`w-full bg-background text-foreground border-[2px] border-foreground px-4 py-3 text-[18px] leading-snug outline-none resize-y placeholder:text-muted-foreground focus:bg-accent focus:shadow-[4px_4px_0_0_var(--foreground)] disabled:opacity-50 ${error ? "border-destructive" : ""} ${className}`}
