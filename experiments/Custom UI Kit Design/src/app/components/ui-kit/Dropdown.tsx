      ...
      <div className="flex flex-col gap-2 w-full">
        ...
        <div className="relative w-full">
          <select
            ref={ref}
            id={inputId}
            className={`w-full appearance-none bg-background text-foreground border-[2px] border-foreground px-4 py-3 pr-12 text-[18px] leading-tight outline-none focus:bg-accent focus:shadow-[4px_4px_0_0_var(--foreground)] disabled:opacity-50 ${error ? "border-destructive" : ""} ${className}`}
